...
from motion_infiller.data.egobody_dataset import EgobodyDataset
...
if __name__ == '__main__':
    ...
    if process_rank == -1:
        ...
        if not args.tmp:
            pass
            # wandb_logger = WandbLogger(project="GLAMR.motion_infiller",
            # name=f'{cfg.id}_v{version}', save_dir=f'{tb_logger.log_dir}')
